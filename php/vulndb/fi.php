...
$sql = "delete from inc_fich where id in ('$cheks')";
...
?>
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left">Inclus&#xE3;o de Ficheiros</div>
                            </div>
...
?>
						                <tr>
						                  <td><a href="<?php echo $row['url'];?>"><?php echo (strlen($row['url']) > 50 ? substr($row['url'], 0, 50)."..." : $row['url']);?></td>
